...
servidor: ./servidor/servidor.o ./servidor/servidorConfig.o ./util/ficheiro.o ./util/config.o
	$(CC) -g -o ./servidor/servidor ./servidor/servidor.o ./servidor/servidorConfig.o ./util/ficheiro.o ./util/config.o $(LDFLAGS)
